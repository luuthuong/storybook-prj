...
export function ButtonKit(props: ButtonProps) {
...
import * as React from "react";
export { ButtonKit, type ButtonProps } from "./Button";
...
<Meta title="Components/Button" component={ButtonKit} />
...
- `yarn dev`: Starts Storybook in dev mode with hot reloading at `localhost:8001`
